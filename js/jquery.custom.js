...
jQuery(document).ready(function($) {
	...
	$('#slider, #featured .carousel-inner, #primary .image, .widget, .media-content, .author, .related, #comments ol li, #respond').addClass('no-display');
	
	$('#slider, #featured .carousel-inner, #primary .image, .widget, .media-content, .author, .related, #comments ol li, #respond').one('inview', function() {
