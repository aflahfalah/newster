...
jQuery(document).ready(function($) {
	...
	$('#slider, .masonry .box, .widget, .media-content, .content, .author, .related, #comments ol li, #respond').addClass('no-display');
	
	$('#slider, .masonry .box, .widget, .media-content, .content, .author, .related, #comments ol li, #respond').one('inview', function() {
